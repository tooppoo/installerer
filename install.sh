...
#   owner: tooppoo
#   repo: installerer
#   binary.name: installerer
#   binary.pathInArchive: installerer
...
OWNER='tooppoo'
REPO='installerer'
BINARY_NAME='installerer'
BINARY_PATH_IN_ARCHIVE='installerer'
...
print_requirements() {
  ...
  printf '%s\n' '- tr: Encodes URL path segments, canonicalizes OS names, and normalizes expected checksums to lowercase.'
